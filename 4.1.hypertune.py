...
# only these two galaxy types
galaxy_classes    = [50, 51]

# data sizes and scattering parameters
...
for lr, reg, ls, J_val, L_val, order_val, crop, down, ver in product(
    ...
    print(f"\n▶ Experiment: lr={lr}, reg={reg}, ls={ls}, J={J}, L={L}, crop={crop_size}, down={down}, ver={ver}")
            ...
            for classifier_name, model_details in models.items():
                ...
                for subset_size in dataset_sizes[fold]:
                    ...
                    for experiment in range(num_experiments):
                        ...
                        initialize_metrics(metrics, gen_model_name, subset_size, fold, experiment, lr, reg, lambda_generate, crop_size, downsample_size, version)
                        ...
                        with torch.no_grad(): # Evaluate on test data
                            ...
                            update_metrics(metrics, gen_model_name, subset_size, fold, experiment, lr, reg, accuracy, precision, recall, f1, lambda_generate, crop_size, downsample_size, version)
