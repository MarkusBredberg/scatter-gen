...
def load_PSZ2(path=root_path + "PSZ2/classified/T100kpcSUB", fold=5, BALANCE=False, AUGMENT=False, sample_size=300, target_classes=[53], crop_size=(1, 256, 256), downsample_size=(1, 256, 256), island=True, REMOVEOUTLIERS=True, train=False, EXTRADATA=False):
                ...
                for file_name in os.listdir(folder_path):
                    if file_name.lower().endswith((".jpg", ".jpeg", ".png")):
                        ...
                        with Image.open(file_path) as img:
                            ...
                            labels.append(label)
                            filenames.append(os.path.splitext(file_name)[0]) # strip off “.png” (or “.jpg”) to get the slug
